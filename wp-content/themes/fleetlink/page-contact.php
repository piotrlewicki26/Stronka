...
<div class="page-hero">
	<div class="container">
		<h1 class="page-hero-title"><?php esc_html_e( 'Contact Us', 'fleetlink' ); ?></h1>
		<p class="page-hero-subtitle">
			<?php esc_html_e( 'Get in touch with our team. We respond within 1 business day.', 'fleetlink' ); ?>
		</p>
	</div>
</div>
		...
		<div class="contact-grid">
			...
			<div class="contact-form-card">
				<h2 style="font-size:1.5rem; font-weight:700; color:var(--color-primary); margin-bottom:.5rem;">
					<?php esc_html_e( 'Send us a message', 'fleetlink' ); ?>
				</h2>
				<p style="font-size:.875rem; color:var(--color-gray-600); margin-bottom:2rem;">
					<?php esc_html_e( 'Fill out the form below and we\'ll get back to you as soon as possible.', 'fleetlink' ); ?>
				</p>
				...
				<form class="fm-form" id="contact-form" novalidate>
					<?php wp_nonce_field( 'fleetlink_nonce', 'nonce' ); ?>

					<div class="form-row">
						<div class="form-group">
							<label for="contact-name"><?php esc_html_e( 'Full Name', 'fleetlink' ); ?> <span aria-hidden="true" style="color:var(--color-danger);">*</span></label>
							<input type="text" id="contact-name" name="name" required autocomplete="name"
							       placeholder="<?php esc_attr_e( 'Jan Kowalski', 'fleetlink' ); ?>">
						</div>
						<div class="form-group">
							<label for="contact-email"><?php esc_html_e( 'Email Address', 'fleetlink' ); ?> <span aria-hidden="true" style="color:var(--color-danger);">*</span></label>
							<input type="email" id="contact-email" name="email" required autocomplete="email"
							       placeholder="<?php esc_attr_e( 'jan@firma.pl', 'fleetlink' ); ?>">
						</div>
					</div>

					<div class="form-row">
						<div class="form-group">
							<label for="contact-company"><?php esc_html_e( 'Company Name', 'fleetlink' ); ?></label>
							<input type="text" id="contact-company" name="company" autocomplete="organization"
							       placeholder="<?php esc_attr_e( 'Twoja Firma Sp. z o.o.', 'fleetlink' ); ?>">
						</div>
						<div class="form-group">
							<label for="contact-phone"><?php esc_html_e( 'Phone Number', 'fleetlink' ); ?></label>
							<input type="tel" id="contact-phone" name="phone" autocomplete="tel"
							       placeholder="<?php esc_attr_e( '+48 000 000 000', 'fleetlink' ); ?>">
						</div>
					</div>

					<div class="form-group">
						<label for="contact-fleet-size"><?php esc_html_e( 'Fleet Size', 'fleetlink' ); ?></label>
						<select id="contact-fleet-size" name="fleet_size">
							<option value=""><?php esc_html_e( '-- Select fleet size --', 'fleetlink' ); ?></option>
							<option value="1-5"><?php esc_html_e( '1–5 vehicles', 'fleetlink' ); ?></option>
							<option value="6-25"><?php esc_html_e( '6–25 vehicles', 'fleetlink' ); ?></option>
							<option value="26-100"><?php esc_html_e( '26–100 vehicles', 'fleetlink' ); ?></option>
							<option value="100+"><?php esc_html_e( '100+ vehicles', 'fleetlink' ); ?></option>
						</select>
					</div>

					<div class="form-group">
						<label for="contact-subject"><?php esc_html_e( 'Subject', 'fleetlink' ); ?></label>
						<select id="contact-subject" name="subject">
							<option value="general"><?php esc_html_e( 'General enquiry', 'fleetlink' ); ?></option>
							<option value="sales"><?php esc_html_e( 'Sales & pricing', 'fleetlink' ); ?></option>
							<option value="support"><?php esc_html_e( 'Technical support', 'fleetlink' ); ?></option>
							<option value="partnership"><?php esc_html_e( 'Partnership', 'fleetlink' ); ?></option>
							<option value="demo"><?php esc_html_e( 'Request a demo', 'fleetlink' ); ?></option>
						</select>
					</div>

					<div class="form-group">
						<label for="contact-message"><?php esc_html_e( 'Message', 'fleetlink' ); ?> <span aria-hidden="true" style="color:var(--color-danger);">*</span></label>
						<textarea id="contact-message" name="message" required rows="5"
						          placeholder="<?php esc_attr_e( 'Tell us about your fleet and what you\'d like to achieve…', 'fleetlink' ); ?>"></textarea>
					</div>
						...
						<label style="display:flex; align-items:flex-start; gap:.5rem; font-weight:400; cursor:pointer;">
							...
							<span style="font-size:.8rem; color:var(--color-gray-600);">
								...
								printf(
									...
									esc_html__( 'I agree to the %1$sPrivacy Policy%2$s and consent to processing my data.', 'fleetlink' ),
					...
					<button type="submit" class="btn btn-primary w-full" id="contact-submit">
						<?php esc_html_e( 'Send Message', 'fleetlink' ); ?>
					</button>
				</form>
			...
			<div class="contact-info-card">
				<h2 style="font-size:1.5rem; font-weight:700; color:white; margin-bottom:2rem;">
					<?php esc_html_e( 'Get in touch', 'fleetlink' ); ?>
				</h2>
				...
				$info_items = array(
					array(
						'icon'    => 'phone',
						'label'   => __( 'Phone', 'fleetlink' ),
						'value'   => get_theme_mod( 'company_phone', '+48 22 123 456 789' ),
						'href'    => 'tel:' . preg_replace( '/[^+\d]/', '', get_theme_mod( 'company_phone', '+48221234567' ) ),
					),
					array(
						'icon'    => 'mail',
						'label'   => __( 'Email', 'fleetlink' ),
						'value'   => get_theme_mod( 'company_email', 'contact@fleetlink.pl' ),
						'href'    => 'mailto:' . get_theme_mod( 'company_email', 'contact@fleetlink.pl' ),
					),
					array(
						'icon'    => 'address',
						'label'   => __( 'Address', 'fleetlink' ),
				...
				<div style="display:flex; gap:1rem; align-items:flex-start; margin-bottom:1.5rem;">
					<div style="width:44px; height:44px; background:rgba(255,255,255,.1); border-radius:var(--radius-lg); display:flex; align-items:center; justify-content:center; flex-shrink:0; color:white;">
						<?php echo fleetlink_icon( $item['icon'] ); // phpcs:ignore ?>
					</div>
					<div>
				...
				<div style="margin-top:2.5rem; padding-top:2rem; border-top:1px solid rgba(255,255,255,.1);">
					<h3 style="font-size:.875rem; font-weight:700; color:white; text-transform:uppercase; letter-spacing:.08em; margin-bottom:1rem;">
						<?php esc_html_e( 'Office Hours', 'fleetlink' ); ?>
					</h3>
					<p style="font-size:.85rem; color:rgba(255,255,255,.65); margin-bottom:.5rem;">
						<?php esc_html_e( 'Monday – Friday: 8:00 – 18:00 CET', 'fleetlink' ); ?>
					</p>
					<p style="font-size:.85rem; color:rgba(255,255,255,.65);">
						<?php esc_html_e( 'Saturday: 9:00 – 14:00 CET', 'fleetlink' ); ?>
					</p>
					<p style="font-size:.85rem; color:rgba(40,167,69,.8); margin-top:1rem; font-weight:600;">
						<?php esc_html_e( '🟢 Technical support available 24/7', 'fleetlink' ); ?>
					</p>
				</div>
...
<div style="height:400px; background:var(--color-gray-200); position:relative; overflow:hidden;">
	...
	<div style="position:absolute; inset:0; display:flex; flex-direction:column; align-items:center; justify-content:center; color:var(--color-gray-500);">
		<?php echo fleetlink_icon( 'map' ); // phpcs:ignore ?>
		<p style="margin-top:.5rem; font-size:.875rem;">
			<?php esc_html_e( 'Map — add your Google Maps embed here', 'fleetlink' ); ?>
		</p>
		<?php
